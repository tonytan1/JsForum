...
public class Include {
	...
	public static String body(String username) {
		String body = Table_start() + Table_title("InfoBar", 1, "left") + Table_start_body() + Table_body(new Date().toString(), 0) + Table_close_body() + Table_close() + "<Body>\n"
				+ "<center><a href=\"..\\forum\\index.jsp\"><img src=\"..\\logo.jpg\" border=\"0\"></a></center>\n" + "<br>\n" + Table_start() + Table_title("ToolBar", 1, "left") + Table_start_body()
				+ Table_body("Logged in as:<b> " + username.toUpperCase() + "</b>&nbsp;&nbsp;&nbsp;" + "<a href=\"forum.Profile\">Your Profile</a>", 0) + Table_close_body() + Table_close() + "<br>\n";

		return (body);
	}

	public static String Table_start() {
		String Table_start = "<TABLE cellSpacing=\"0\" cellPadding=\"0\" width=\"90%\" bgColor=\"#336699\" border=\"0\" align=\"center\">\n" + "<TR>\n" + "<TD>\n"
	...
	public static String Table_title(String title, int colspan, String align) {
		String Table_title = "<TD align=\"" + align + "\" colspan=\"" + colspan + "\">" + "<FONT face=Verdana,Arial,Helvetica color=#003366 size=1>" + "<B>" + title + "</B>" + "</FONT>" + "</TD>";
		return Table_title;
	}
	...
	public static String Table_body(String body, int width) {
		String Table_body = "<TD align=\"left\" valign=\"top\" width=\"" + width + "\">" + "<FONT face=Verdana,Arial,Helvetica color=#003366 size=1>" + body + "</FONT>" + "</TD>";
		return Table_body;
	}
	...
	public static String Table_close() {
		String Table_close = "</TABLE>" + "</TD>" + "</TR>" + "</TABLE>";
		return Table_close;
	}

	public static String emoticons() {
		String emoticons = "<table cellSpacing=\"0\" cellPadding=\"5\" width=\"100%\">\n" + "<tr>\n"
	...
	public static String footer() {
		String foot = "<br><center>&copy; 2002 by <a href=mailto:grieks03@ie.hva.nl>Erwin</a></center>" + "</Body>\n" + "</Html>\n";
		return (foot);
	}
}